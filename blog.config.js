...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xhn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🈚️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xhn.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'not a blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mail@xhn.asia', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://linkedin.in', // 你的linkedIn 首页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || 'Freedom website', // 备案号 闽ICP备XXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Notion A BLOG', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个Not Only A Blog站点', // 站点描述，被notion中的页面描述覆盖
