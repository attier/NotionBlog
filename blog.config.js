...
const BLOG = {
  ...
  AUTHOR: 'xhn', // 作者
  BIO: '🈚️', // 作者简介
  LINK: 'https://blog.xhn.asia', // 网站地址
  KEYWORDS: 'not a blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'mail@xhn.asia', // 邮箱
  CONTACT_WEIBO: 'https://weibo.com', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: 'https://linkedin.in', // 你的linkedIn 首页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Not a BLOG', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个Not Only Blog站点', // 站点描述，被notion中的页面描述覆盖
